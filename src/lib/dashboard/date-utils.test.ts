...
describe("mondayIndex", () => {
  // Constructed via (year, monthIndex, day) — local-midnight, matching how
  // mondayIndex is actually called (real Date instants), unlike a bare
  // "YYYY-MM-DD" string which parses as UTC midnight and shifts a day in
